    ...
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-4 flex-grow-0 pl-6 pr-6">
          ...
          <h3 className="text-base font-bold text-deadGray">{titulo}</h3>
        </div>
        ...
        <div className="flex space-x-4 items-center ml-auto text-right">
          ...
          <button className="border-none bg-[#949494] hover:bg-brightBlue text-white font-semibold text-base py-1 px-10 rounded-full transition">
            Ver &gt;&gt;
          </button>
        </div>
      </div>
